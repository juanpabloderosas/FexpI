...
\item[b)] Exprese $log(r)$ como función de $log(m)$  en la ecuación anterior.
\item[c)] Escriba una ecuación del radio en función de la masa $r(m)$, utilizando una dimensión arbitraria $D_f$ (puede utilizar una constante de proporcionalidad A en lugar del volumen de una esfera y la densidad).
\end{itemize}
